...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=['work_dirs/ctrgcn/ctrgcn_fsd10/fuse/j.pkl', 'work_dirs/ctrgcn/ctrgcn_fsd10/fuse/b.pkl'])
    parser.add_argument(
        '--coefficients',
        nargs='+',
        type=float,
...
def main():
    ...
    for data_samples in data_sample_list:
        scores = [
            sample['pred_scores'] for sample in data_samples
        ]
        score_list.append(scores)

    if args.multi_label:
        labels = [
            sample['gt_labels'] for sample in data_sample_list[0]
        ]
    else:
        labels = [
            sample['gt_labels']
