model = dict(
    ...
    backbone=dict(
        type='STGCN',
        graph_cfg=dict(layout='openpose_25', mode='stgcn_spatial')),
...
train_pipeline = [
    ...
    dict(type='GenSkeFeat', dataset='openpose_25', feats=['bm']), # 生成特征，根据feats中的字段选择生成joint或bone以及motion
...
# runtime settings
log_level = 'INFO'
work_dir = './work_dirs/stgcn/stgcn_fsd10/bm'
